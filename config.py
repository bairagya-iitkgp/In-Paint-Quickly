...
parser.add_argument('--train_data_path', dest='train_data_path', default='./npy', help='path to train data file')
parser.add_argument('--test_data_path', dest='test_data_path', default='./x_test4.npy', help='path to test data file')
parser.add_argument('--test_out', dest='test_out', default='./output/', help='path to test data file')
